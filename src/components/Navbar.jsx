...
const navbarLinks = [
  { label: "Principal", href: "/#home", ariaLabel: "Home" },
  { label: "Imágenes", href: "/#features", ariaLabel: "Features" },
...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex items-center relative justify-between">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          exit={{ opacity: 0 }}
        >
          <div className="hidden lg:flex -ml-28 h-full pb-2 ">
